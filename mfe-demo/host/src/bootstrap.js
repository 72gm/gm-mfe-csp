...
//replace script src with the line below to have unsafe-eval allow things to work
//script-src 'unsafe-eval' http://localhost:3000 http://localhost:3001 http://localhost:3002 'strict-dynamic';
const csp = `
default-src 'self';
